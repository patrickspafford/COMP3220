...
(define exp
  (lambda (myEnv e)
    (cond
      ...
      ((eqv? (car e) '/) (/ (exp myEnv (cadr e)) (exp myEnv (caddr e)))) ;; attempt at division
      ((eqv? (car e) '-) (- (exp myEnv (cadr e)) (exp myEnv (caddr e)))) ;; attempt at subtraction
      ((eqv? (car e) '*) (* (exp myEnv (cadr e)) (exp myEnv (caddr e)))) ;; attempt at multiplication
